            ...
            <div>
              <div className="flex flex-col gap-6">
                ...
                <div className="statements flex flex-col gap-8">
                  ...
                  <p className="text-[16px] text-foreground">
                    Welcome to The Madlad Blog, a service provided by Coding
                  ...
                  <ul>
                    <li>
                      ...
                      <p>
                        ...
                        by these Terms, whether or not you are a registered
                        user. If you do not agree to these Terms, you may not
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          Eligibility: You must be at least 13 years old to
                          access or use the Service. By accessing or using the
                          Service, you represent and warrant that you are at
                          least 13 years old.
                        </li>
                        <li>
                          License: Subject to these Terms, we grant you a
                          limited, non-exclusive, non-transferable, and
                          revocable license to access and use the Service for
                        ...
                        <li>
                          ...
                          <ul>
                            ...
                            <li>
                              Use the Service to infringe upon the intellectual
                            ...
                            <li>
                              ...
                              application, or other automated device, process or
                              means to access, retrieve, scrape, or index any
                              portion of the Service.
                            </li>
                            <li>
                              Interfere with or disrupt the operation of the
                              Service or any servers or networks connected to
                              the Service.
                            </li>
                            <li>
                            ...
                            <li>
                              ...
                              of the Service without their consent.
                            </li>
                            <li>
                              Violate any applicable laws or regulations in
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          Ownership: All rights, title, and interest in and to
                          the Service, including all intellectual property
                          rights therein, are and will remain the exclusive
                          property of Coding Madlad.
                        </li>
                        <li>
                    ...
                    <li>
                      ...
                      <p>
                        ...
                        any time, in our sole discretion. If we make any
                        material changes to these Terms, we will notify you by
                        email or by posting a notice on the Website. Your
